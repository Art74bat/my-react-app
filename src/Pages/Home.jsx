...
export default function Home () {
    ...
    return(
        <>
            ...
            <section class={styles.when_call_master}>
                <div class={styles.when_call_master__wrapp}>
                    <h2 class={styles.when_call_master__title}>Когда нужно вызвать мастера</h2>
                    <ul class={styles.when_call_master_card}>
                        <li class={styles.when_call_master_card__title}>НЕ ВКЛЮЧАЕТСЯ МОНИТОР</li>
                        <li class={styles.when_call_master_card__descript}>Убедитесь в исправности розетки и в том, что устройство к ней подключено. Возможно, не все провода или разъемы подключены корректно. Если вы все проверили и уверены, что проблема не в электропитании, поступающем к компьютеру, а в самом устройстве, вероятно монитор перестал работать по причине засорения комплектующих внутри блока. Требуется компьютерная помощь, ремонт и чистка устройства.</li>
                    </ul>
                    <ul class={styles.when_call_master_card}>
                        <li class={styles.when_call_master_card__title}>СИСТЕМНЫЙ БЛОК ИЗДАЕТ СИЛЬНЫЕ ШУМЫ </li>
                    ...
                    <ul class={styles.when_call_master_card}>
                        <li class={styles.when_call_master_card__title}>ПОЯВЛЕНИЕ “СИНЕГО ЭКРАНА СМЕРТИ”</li>
                        <li class={styles.when_call_master_card__descript}>Неисправность операционной системы говорит о наличии вирусов в компьютере. Выход из строя системного блока также может являться причиной поломки и необходимости услуги “компьютерная помощь”.</li>
                    </ul>
                    <ul class={styles.when_call_master_card}>
                        <li class={styles.when_call_master_card__title}>КОМПЬЮТЕР НЕ РАБОТАЕТ И ИЗДАЕТ РЕЗКИЕ ЗВУКИ</li>
                    ...
                    <ul class={styles.when_call_master_card}>
                        <li class={styles.when_call_master_card__title}>ПРОПАЛО ИЗОБРАЖЕНИЕ С МОНИТОРА</li>
